							...
							>
								...
								{triggerSortExam ? (
									<Modal
										...
										closable={true}
										onCancel={() => setTriggerSortExam(false)}
						...
						<Col sm={24} lg={10} md={10} xl={10} xs={24}>
							<Form.Item
								...
								rules={[
									{
										required: true,
										message: "Please select a sort by field",
									},
								]}
							>
								<Select
						...
						<Col>
							<Card bordered={false}>
								{totalExaminees - totalSeats === 0 ? (
									...
									<Statistic
										title="Extra seats"
										value={Math.abs(totalExaminees - totalSeats)}
					...
					<Row gutter={[16, 16]}>
						...
						<Col lg={8} xl={8}>
							{examineesByProgram.length ? (
								<ProgramCountsDisplay data={examineesByProgram} />
							) : null}
						</Col>
					</Row>
					<Divider />
