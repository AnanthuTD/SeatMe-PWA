			...
			translate ? (
				...
				<div className="p-3">
					...
					<p className="sm:text-xs ">
						...
						പരീക്ഷാ ഹാളിൽ ഹാജരാവകണ്ടതാണ്. 1.30 p m ന് ശേഷും
						ഹാജരാകുന്ന വിദ്യാർത്ഥികവള പരീക്ഷാ ഹാളിൽ
						പ്പശവേിപ്പികില്ല. <br /> <br />
						• േരീക്ഷഹാളിൽ, ഹാൾ ടിക്കറ്റ്, ലേനകൾ ടേൻസി ുകൾ സ്ടകയിൽ
						ഇവടയാഴിടക മടറ്റാന്ുും ടകാണ്ടുവരാൻ അനുവാദ്മില്ല. ഏതെങ്കില
						ും െരത്തില ള്ളഇലക്ട്രോണിക്ഉപകരണങ്ങൾ വിദ്യോർത്ഥിയ
						തരകകവശും ഉതെന്ന്കതെത്തിയോൽ, അെ്കെ തകട്ട കയ ും
						മോൽ്പോക്റിസോയി കണക്കോക്ക കയ ും തെയ് ും. <br /> <br />
				...
				<div className="p-3">
					...
					<p className="sm:text-xs ">
						...
						• Students are not allowed to write anything on their
						hall ticket or question paper. If written it will be
						considered as malpractice. <br /> <br />
						(But write the name and register number on the question
						paper compulsorily - only in the space provided). <br />{" "}
						<br />
						If anyone wants to do the rough work, the last page of
						the main book can be used for rough work. Write Rough
						Work at the top of the page. After use of the page,
						strike off. <br /> <br />
						• Students should be present in the examination hall at
						least before 1.20 pm (1.50 pm on Fridays) for the
						afternoon examination. Students appearing after 1.30 p.m
						will not be admitted to the examination hall. <br />{" "}
						<br />
						• Nothing is allowed to be brought in the examination
						hall except hall ticket, pens, pencils and scale. If a
						student is found to be in possession of any type of
						electronic device, it will be confiscated and considered
						a malpractice. <br /> <br />
						...
						ticket will be allowed to appear for the exam. Uniform
						should be as per college rules. <br /> <br />
					</p>
					<h5 className="ml-24">
						{" "}
						- Chief Superintendent / Principal{" "}
