				...
				translate ? (
					<div className="p-3">
						...
						<p className="sm:text-xs ">
							...
							ത്ത്മാപ്തും). <br /> <br />
							ആർടക്കങ്കി ുും റഫ്വർക്ക്ട യ്യ്തു
							നനാക്കണമമന്നുമെങ്കിൽ, പ്രധാന േുസ്കത ത്തി ടെ അവസാന
							ലേജ്റഫ്വർക്കിനായി ഉേലയാഗിക്കാും. ലേജിന്മുകളിൽ
							റഫ്വർക്ക്എടന്ഴുതുക. ഉേലയാഗത്തിന്ലേഷും,
							സ്്പ്െക്ക്ഓഫ്ട യ്യുക(ടവട്ടികളയുക). <br /> <br />
							• വിദ്യാർത്ഥികൾ ഉച്ചയ്ക്കുള്ള പരീക്ഷയ്ക്ക് , 1.20 p
							m ന് ( വവള്ളിയ്കാഴ്കച ളിൽ ഉച്ചയ്ക്ക് 1.50 ന് )
							മുവെങ്കിലുും പരീക്ഷാ ഹാളിൽ ഹാജരാവകണ്ടതാണ്. 1.30 p m
							ന് ശേഷും ഹാജരാകുന്ന വിദ്യാർത്ഥികവള പരീക്ഷാ ഹാളിൽ
							പ്പശവേിപ്പികില്ല. <br /> <br />
							• േരീക്ഷഹാളിൽ, ഹാൾ ടിക്കറ്റ്, ലേനകൾ ടേൻസി ുകൾ
							സ്ടകയിൽ ഇവടയാഴിടക മടറ്റാന്ുും ടകാണ്ടുവരാൻ
							അനുവാദ്മില്ല. ഏതെങ്കില ും െരത്തില
							ള്ളഇലക്ട്രോണിക്ഉപകരണങ്ങൾ വിദ്യോർത്ഥിയ തരകകവശും
					...
					<div className="p-3">
						<h1 className="  align-middle lg:text-xl text-red-500 text-sm ">
							Instructions to the Students(University
							Examinations)
						</h1>
						<p className="sm:text-xs ">
							Read all the instructions and rules given in the
							hall ticket before entering the exam hall.
							Especially instructions: 6,7,9,10 &12 <br /> <br />
							• Students are not allowed to write anything on
							their hall ticket or question paper. If written it
							will be considered as malpractice. <br /> <br />
							(But write the name and register number on the
							question paper compulsorily - only in the space
							provided). <br /> <br />
							...
							of any type of electronic device, it will be
							confiscated and considered a malpractice. <br />{" "}
							<br />
							Standard calculators, which are only allowed for
							certain subjects, may be used. <br /> <br />
							• Only students with full uniform, ID card and hall
							ticket will be allowed to appear for the exam.
							Uniform should be as per college rules. <br />{" "}
							<br />
						</p>
						<h5 className="ml-24">
							{" "}
