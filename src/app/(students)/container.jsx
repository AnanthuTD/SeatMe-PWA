...
const Container = ({ children }) => {
    ...
    return (
        <Layout className="h-full">
            ...
            >
                <div className="flex items-center justify-between">
                    <div className="flex items-center">
                        <Image src={'/seatme.svg'} width={40} height={40} className="border border-solid border-white rounded-full mr-2" />
                        <span className="text-white text-lg font-bold">SeatMe</span>
                    </div>
                </div>

                <div>
                    <InfoCircleTwoTone style={{ fontSize: '20px' }} twoToneColor="#8F94FB" onClick={() => setShowInstruction(!showInstruction)} />
                </div>
            </Header>
            ...
            <InstructionModel onClose={() => setShowInstruction(false)} showInstruction={showInstruction} />
        </Layout >
    );
};
