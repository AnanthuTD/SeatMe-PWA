...
import { Form, Input, InputNumber, Popconfirm, Table, Typography, Button, Space, Statistic, Card, message } from 'antd';
...
const RoomDetail = ({ data, setData, examinesCount, examType }) => {
    ...
    const handleRoomSelection = async () => {
        ...
        try {
            ...
            console.error("Error while sending PATCH request to update room availability:", error);
    ...
    return (
        <div>
            <div className='flex justify-between'>
                ...
                <Button className='place-self-center' type='primary' onClick={handleRoomSelection} loading={submitting}>Submit</Button>
            </div>
